...
# set -xv
array=()
for file in xgb_isclicked_sanitized_r1_f_6_r2_f_2_f_4_f_16*log;
do 
    #echo $file
...
rm -rf best_embedding/gnn_emb_is_clicked.csv.gz
rm -rf best_embedding/model_graphsage_2L_64_isclicked.pt
rm -rf best_embedding/node_emb_isclicked.pt

echo "Found best trial to be ${best_idx} and stored it in best_embedding/"
# ln -s graph_data/tabular_with_gnn_emb_is_clicked_sanitized_trial_${best_idx}.csv.gz best_embedding/gnn_emb_is_clicked.csv.gz
cd best_embedding
cp ../graph_data/click_model_graphsage_2L_64_trial_${best_idx}.pt model_graphsage_2L_64_isclicked.pt
cp -s ../graph_data/click_node_emb_trial_${best_idx}.pt node_emb_isclicked.pt